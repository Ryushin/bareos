...
static int date_item([[maybe_unused]] JobControlRecord* jcr,
                     int code,
                     const char** val_ptr,
                     int* val_len,
                     int* val_size)
 ...
 */
static var_rc_t lookup_built_in_var([[maybe_unused]] var_t* ctx,
                                    void* my_ctx,
                                    const char* var_ptr,
                                    int var_len,
...
static var_rc_t lookup_counter_var([[maybe_unused]] var_t* ctx,
                                   void* my_ctx,
                                   const char* var_ptr,
                                   int var_len,
                                   int var_inc,
 ...
 */
static var_rc_t operate_var([[maybe_unused]] var_t* var,
                            [[maybe_unused]] void* my_ctx,
                            const char* op_ptr,
                            int op_len,
                            const char* arg_ptr,
                            [[maybe_unused]] int arg_len,
                            const char* val_ptr,
                            int val_len,
                            [[maybe_unused]] char** out_ptr,
                            [[maybe_unused]] int* out_len,
                            int* out_size)
{
  CounterResource* counter;
  PoolMem buf(PM_NAME);
